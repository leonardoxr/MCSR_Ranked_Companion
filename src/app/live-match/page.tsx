...
import { getSafeExternalUrl, openSafeExternalUrl } from '@/lib/utils/safeExternalUrl';
...
export default function LiveMatchPage() {
  ...
  const {
    username,
    privateKey,
    privateKeyRevision: authRevision,
    isAuthenticated,
  } = useAuthStore();
        ...
        <CardContent>
          <div className="space-y-4">
            {players.map((player) => {
              ...
              const liveUrl = getSafeExternalUrl(data?.liveUrl);
                      ...
                      <div className="text-right">
                        ...
                        {liveUrl && (
                          <Button
                            ...
                            size="sm"
                            className="mt-2"
                            onClick={() => openSafeExternalUrl(liveUrl)}
                          >
                            Watch Live
                          </Button>
                        )}
