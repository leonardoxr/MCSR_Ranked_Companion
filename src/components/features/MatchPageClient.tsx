    ...
    <div className="container mx-auto px-4 py-6 sm:py-8 space-y-6">
              ...
              >
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    {match.changes.find(c => c.uuid === match.players[0].uuid) && (
                      <div className={cn(
                        'flex items-center gap-1 font-semibold',
                        match.changes.find(c => c.uuid === match.players[0].uuid)!.change > 0
                          ? 'text-emerald'
                          : 'text-destructive'
                      )}>
                        {match.changes.find(c => c.uuid === match.players[0].uuid)!.change > 0 ? (
                        ...
                        {match.changes.find(c => c.uuid === match.players[0].uuid)!.change > 0 ? '+' : ''}
                        {match.changes.find(c => c.uuid === match.players[0].uuid)!.change}
                      </div>
                    )}
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <div className="flex flex-col items-center gap-1">
                    ...
                    {match.changes.find(c => c.uuid === match.players[1].uuid) && (
                      <div className={cn(
                        'flex items-center gap-1 font-semibold',
                        match.changes.find(c => c.uuid === match.players[1].uuid)!.change > 0
                          ? 'text-emerald'
                          : 'text-destructive'
                      )}>
                        {match.changes.find(c => c.uuid === match.players[1].uuid)!.change > 0 ? (
                        ...
                        {match.changes.find(c => c.uuid === match.players[1].uuid)!.change > 0 ? '+' : ''}
                        {match.changes.find(c => c.uuid === match.players[1].uuid)!.change}
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm uppercase">{match.seed.overworld.replace(/_/g, ' ')}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm uppercase">{match.seed.nether}</p>
                </div>
              </div>
              <div className="w-px h-8 bg-border hidden sm:block" />
              <div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground truncate">{vod.url}</p>
                    </div>
      ...
      <div className="text-center text-sm text-muted-foreground space-y-1">
        ...
        <p className="font-mono text-xs">
          Match #{match.id} · Seed: {match.seed.id}
        </p>
      </div>
    </div>
  );
