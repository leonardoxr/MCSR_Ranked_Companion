  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        // Match types
        ranked: 'border-transparent bg-emerald text-white',
        casual: 'border-transparent bg-diamond text-white',
        private: 'border-transparent bg-gold text-white',
        event: 'border-transparent bg-redstone text-white',
      },
    },
    defaultVariants: {
      variant: 'default',
